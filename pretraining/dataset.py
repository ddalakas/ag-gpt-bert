"""
This file was modified based on the original file from the official GPT-BERT GitHub at https://github.com/ltgoslo/gpt-bert.

A CausalValidationDataset class was added in order to compute the model's causal perplexity at each validation step.
...
class MaskedValidationDataset(torch.utils.data.Dataset):
...
class CausalValidationDataset(torch.utils.data.Dataset):
    def __init__(self, input_file: str, tokenizer, args):
        self.path = input_file
        self.seq_length = args.seq_length
        self.n_special_tokens = args.n_special_tokens
