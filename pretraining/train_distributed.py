...
def parse_arguments():
    ...
    parser.add_argument("--wandb_project", default="AG_GPT-BERT", type=str, help="Name of the WandB project to log into.")
    parser.add_argument("--wandb_entity", default="ddalakas-university-of-cape-town", type=str, help="The entity to log to on WandB (typically your wandb username).")
